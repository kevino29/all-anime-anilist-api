...
let lastPage, search, format, genre, tag, sort;
let currentPage = 1;
...
const buttonTexts = 
    [
        ...
        ['None', "4-koma", "Achromatic", "Achronological Order", "Acting", "Advertisement", "Afterlife",
         ...
         "Ghost", "Go", "Goblin", "Gods", "Golf", "Gore", "Guns", "Gyaru", "Harem", "Henshin", "Hikikomori", "Historical",
         "Ice Skating", "Idol", "Isekai", "Iyashikei", "Josei", "Kaiju", "Karuta", "Kemonomimi", "Kids", "Kuudere",
         "Lacrosse", "Language Barrier", "LGBTQ+ Themes", "Lost Civilization", "Love Triangle", "Mafia", "Magic",
         "Mahjong", "Maids", "Male Protagonist", "Martial Arts", "Medicine", "Memory Manipulation", "Mermaid", "Meta",
         "Military", "Monster Girl", "Mopeds", "Motorcycles", "Musical", "Mythology", "Nekomimi", "Ninja", "No Dialogue",
         "Noir", "Nudity", "Nun", "Office Lady", "Oiran", "Ojou-sama", "Otaku Culture", "Outdoor", "Pandemic", "Parody", 
         "Philosophy", "Photography", "Pirates", "Poker", "Police", "Politics", "Post-Apocalyptic", "POV", 
         "Primarily Adult Cast", "Primarily Child Cast", "Primarily Female Cast", "Primarily Male Cast", "Puppetry",
         "Rakugo", "Real Robot", "Rehabilitation", "Reincarnation", "Revenge", "Reverse Harem", "Robots", "Rotoscoping",
         "Rugby", "Rural", "Samurai", "Satire", "School", "School Club", "Scuba Diving", "Seinen", "Shapeshifting", "Ships",
         "Shogi", "Shoujo", "Shounen", "Shrine Maiden", "Skateboarding", "Skeleton", "Slapstick", "Slavery",
