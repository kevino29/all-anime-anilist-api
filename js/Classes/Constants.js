class Constants {
    constructor() {
        ...
        this._url = 'https://graphql.anilist.co';
        ...
        `
            query ($page: Int, $search: String, $format: MediaFormat, $status: MediaStatus, $season: MediaSeason, 
                ...
                Page (page: $page, perPage: 48) {
                    ...
                    media (search: $search, format: $format, status: $status, season: $season, seasonYear: $year, 
                        genre_in: $genres, tag_in: $tags, sort: $sort, isAdult: $isAdult) {
                        id
                        type
                        siteUrl
                        tags {
        ...
        // Set the all filter dropdown objects
        this._filterDropdowns = 
        [
            {
                'title': 'Format',
                'default': 'All',
            ...
            },
            {
                ...
                'default': 'None',
                'multi-select': true,
                'multi-select-text': 'See all genres',
                'separate-categories': false,
                'collection': [
                    {
                        'category': 'A',
            ...
            },
            {
                ...
                'default': 'None',
                'multi-select': true,
                'multi-select-text': 'See all tags',
    ...
    get filterDropdowns() { return this._filterDropdowns; }
